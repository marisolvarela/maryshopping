...
/**
 * Flyway configuration properties with Railway-Oriented Programming patterns.
 * 
 * This configuration provides database migration properties using functional
 * property binding. All configuration values are validated and guaranteed non-null.
 */
@Configuration
@Getter
@Setter
